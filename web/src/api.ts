...
export const api = {
  ...
  /** Embed info for the public web widget (LAN + public-tunnel URL + iframe snippet). */
  widgetInfo: (id: string) =>
    req<{ enabled: boolean; localUrl: string; publicUrl: string; snippet: string }>('GET', `/api/timetables/${id}/widget-info`),
